...
Route::get('/editquestion/{id}',[QuestionsController::class,'getEditedQuestion']);
Route::post('/updatequestion',[QuestionsController::class,'UpdateQuestion'])->name('updatequestion');
});
